...
class TrackerTravellingResponse {
    @SerializedName("success")
    @Expose
    var success: Boolean? = null

    @SerializedName("v_site_travelling_tracker")
    @Expose
    var vSiteTravellingTracker: List<VSiteTravellingTracker?>? = null
