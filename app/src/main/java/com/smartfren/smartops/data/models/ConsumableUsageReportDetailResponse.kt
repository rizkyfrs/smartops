...
class ConsumableUsageReportDetailResponse {
    ...
    @Expose
    val cvConsflmreport: CvConsflmreport? = null
    ...
    class CvConsflmreport {
        ...
        @SerializedName("cflm_usage_before")
        @Expose
        var cflmUsageBefore: String? = null

        @SerializedName("cflm_usage_after")
        @Expose
        var cflmUsageAfter: String? = null
