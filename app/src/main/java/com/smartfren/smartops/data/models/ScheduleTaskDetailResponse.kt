...
class ScheduleTaskDetailResponse {
    ...
    class Task {
        ...
        @SerializedName("pendingRemarks1")
        @Expose
        var pendingRemarks1: String? = null

        @SerializedName("pendingRemarks2")
        @Expose
        var pendingRemarks2: String? = null
    }
}