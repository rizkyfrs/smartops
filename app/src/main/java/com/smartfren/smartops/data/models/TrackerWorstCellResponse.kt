...
class TrackerWorstCellResponse {
    @SerializedName("success")
    @Expose
    var success: Boolean? = null

    @SerializedName("v_site_worstcell_tracker")
    @Expose
    var vSiteWorstcellTracker: List<VSiteWorstcellTracker>? = null
