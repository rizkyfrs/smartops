...
class TrackerAccessibilityResponse {
    @SerializedName("success")
    @Expose
    var success: Boolean? = null

    @SerializedName("v_site_accessibility_tracker")
    @Expose
    var vSiteAccessibilityTracker: List<VSiteAccessibilityTracker?>? = null
    ...
    class VSiteAccessibilityTracker {
