...
class TrackerGroundingResponse {
    @SerializedName("success")
    @Expose
    var success: Boolean? = null

    @SerializedName("v_site_grounding_tracker")
    @Expose
    var vSiteGroundingTracker: List<VSiteGroundingTracker?>? = null
