...
public class RadioInfo {
    ...
    private int lte_RSSI = Integer.MAX_VALUE; //Integer.MAX_VALUE 无效
...
//                Method getLteRssi = signalStrength.getClass().getDeclaredMethod("getLteRssi");
//                getLteRssi.setAccessible(true);
//                lte_RSSI = (int) getLteRssi.invoke(signalStrength);
            ...
            for (CellInfo cellInfo : cellInfoList) {
                ...
                if (cellInfo instanceof CellInfoLte) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                        provider = lteinfo.getCellIdentity().getOperatorAlphaLong().toString();
                        ...
                        lte_RSRP = lteinfo.getCellSignalStrength().getRsrp();
                        lte_RSRQ = lteinfo.getCellSignalStrength().getRsrq();
                        lte_SINR = lteinfo.getCellSignalStrength().getRssnr();
                        lte_RSSI = lteinfo.getCellSignalStrength().getDbm();
                    }
