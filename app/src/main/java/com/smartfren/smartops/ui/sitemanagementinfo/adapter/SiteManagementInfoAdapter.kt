...
class SiteManagementInfoAdapter(private val context: Context) :
    RecyclerView.Adapter<SiteManagementInfoAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvSiteStatus.gravity = Gravity.LEFT
        ...
        holder.tvSiteTech.text = item.typeFive
        holder.tvOMReg.text = item.typeSix
        holder.tvMorphology.text = item.typeSeven

        holder.itemLayout.setOnClickListener {
            val intent = Intent(context, SiteManagementInfoDetailActivity::class.java)
            intent.putExtra("siteID", item.typeOne)
