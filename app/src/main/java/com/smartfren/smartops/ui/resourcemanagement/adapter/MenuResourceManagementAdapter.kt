package com.smartfren.smartops.ui.resourcemanagement.adapter
...
class MenuResourceManagementAdapter(private val context: Context) : RecyclerView.Adapter<MenuResourceManagementAdapter.ViewHolder>() {
