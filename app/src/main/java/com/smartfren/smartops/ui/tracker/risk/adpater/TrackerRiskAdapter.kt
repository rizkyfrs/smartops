...
class TrackerRiskAdapter(private val context: Context) :
    RecyclerView.Adapter<TrackerRiskAdapter.ViewHolder>() {
    private val mList: ArrayList<TrackerRiskListResponse.CvRegrtrackerOp> = ArrayList()
    ...
    fun updateList(lstItem: List<TrackerRiskListResponse.CvRegrtrackerOp>) {
