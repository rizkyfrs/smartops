...
class MarkerDemoActivity :
    ...
    internal inner class CustomInfoWindowAdapter : InfoWindowAdapter {
        ...
        private fun render(marker: Marker, view: View) {
            val badge = when (marker.title!!) {
                "Brisbane" -> R.drawable.ic_alarm
                "Adelaide" -> R.drawable.ic_battery
                "Sydney" -> R.drawable.ic_key
                "Melbourne" -> R.drawable.ic_info
                "Perth" -> R.drawable.ic_report
                in "Darwin Marker 1".."Darwin Marker 4" -> R.drawable.ic_lock
    ...
    private fun addMarkersToMap() {
        ...
        val placeDetailsMap = mutableMapOf(
                ...
                "SYDNEY" to PlaceDetails(
                    ...
                    icon = vectorToBitmap(
                        R.drawable.ic_wifi, Color.parseColor("#A4C639")),
    ...
    override fun onMarkerDragStart(marker : Marker) {
        topText.text = "on_marker_drag_start"
    }

    override fun onMarkerDragEnd(marker : Marker) {
        topText.text = "on_marker_drag_end"
    }

    override fun onMarkerDrag(marker : Marker) {
        topText.text = "on_marker_drag" + " " + marker.position.latitude + " " + marker.position.longitude
    }
