package com.smartfren.smartops.ui.supportmanagement.adapter
...
class MenuSupportManagementAdapter(private val context: Context) : RecyclerView.Adapter<MenuSupportManagementAdapter.ViewHolder>() {
