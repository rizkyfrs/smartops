package com.smartfren.smartops.ui.corefacility.adapter
...
class MenuCoreFacilityAdapter(private val context: Context) : RecyclerView.Adapter<MenuCoreFacilityAdapter.ViewHolder>() {
