package com.smartfren.smartops.ui.towermanagement.adapter
...
class MenuTowerManagementAdapter(private val context: Context) : RecyclerView.Adapter<MenuTowerManagementAdapter.ViewHolder>() {
