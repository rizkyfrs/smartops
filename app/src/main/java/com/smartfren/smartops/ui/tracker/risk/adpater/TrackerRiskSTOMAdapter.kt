...
import com.smartfren.smartops.data.models.TrackerRiskListSTOMResponse
...
class TrackerRiskSTOMAdapter(private val context: Context) :
    RecyclerView.Adapter<TrackerRiskSTOMAdapter.ViewHolder>() {
    private val mList: ArrayList<TrackerRiskListSTOMResponse.CvRegrtrackerStom> = ArrayList()
    ...
    fun updateList(lstItem: List<TrackerRiskListSTOMResponse.CvRegrtrackerStom>) {
