package com.smartfren.smartops.ui.fibermanagement.adapter
...
class MenuFiberManagementAdapter(private val context: Context) : RecyclerView.Adapter<MenuFiberManagementAdapter.ViewHolder>() {
