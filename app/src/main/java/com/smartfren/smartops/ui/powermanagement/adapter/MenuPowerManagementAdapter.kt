package com.smartfren.smartops.ui.powermanagement.adapter
...
class MenuPowerManagementAdapter(private val context: Context) : RecyclerView.Adapter<MenuPowerManagementAdapter.ViewHolder>() {
