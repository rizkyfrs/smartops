...
class SubMenuMaterialManagementActivity : BaseActivity() {
    ...
    private fun setupUI() {
        ...
        menuList.add(ContentMenu(3, "Consumable Part Management", R.drawable.ic_assignment))
        menuList.add(ContentMenu(4, "Spare Part Management", R.drawable.ic_assignment))
