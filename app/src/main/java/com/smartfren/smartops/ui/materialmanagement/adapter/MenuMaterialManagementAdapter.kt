package com.smartfren.smartops.ui.materialmanagement.adapter
...
class MenuMaterialManagementAdapter(private val context: Context) : RecyclerView.Adapter<MenuMaterialManagementAdapter.ViewHolder>() {
