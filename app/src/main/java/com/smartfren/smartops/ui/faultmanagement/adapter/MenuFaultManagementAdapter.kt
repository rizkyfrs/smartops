package com.smartfren.smartops.ui.faultmanagement.adapter
...
class MenuFaultManagementAdapter(private val context: Context) : RecyclerView.Adapter<MenuFaultManagementAdapter.ViewHolder>() {
